...
export default function UserPage() {
    ...
    const hideBackButton = location.pathname === '/user/vendor' || location.pathname === '/user' || location.pathname === '/user/';
    ...
    return (
        <div className="min-h-screen flex   justify-center  sm:px-4 px-0 bg-gradient-to-br from-orange-50 to-orange-100 ">
            <div className=" w-full sm:max-w-sm   text-center">
                ...
                <div className='p-3 flex justify-between text-gray-500  mb-2'>
                    <span>
